...
public class CacheBinaryMessage implements Message {
    ...
    public CacheBinaryMessage(){
        
    }
    
    public CacheBinaryMessage(String messageId, Long senderId, Long receiverId, byte[] data, String senderName,
            String receiverName, String fileName, byte finish, int packageNo, Long dateTime, String size) {
        super();
    ...
    public void fromBinary(ByteBuf buffer) {
        ...
        data = dataBytes;
        this.length = 2+16+8+1+8+1+1+1+2+4+8+data.length+Utils.getUTF8StringLength(senderName)+Utils.getUTF8StringLength(receiverName)+Utils.getUTF8StringLength(fileName);
    ...
    public void fromMap(Map<String, JsonNode> map) {
        ...
        size=map.get("size").asText();
        length = 2+8+1+8+1+1+1+2+4+8+data.length+Utils.getUTF8StringLength(senderName)+Utils.getUTF8StringLength(receiverName)+Utils.getUTF8StringLength(fileName)/*+16*/;
