...
public class CommentMessage implements Message{
	...
	public CommentMessage(Long senderId, Long receiverId, String senderName,
			String receiverName, String content, Long date) {
		super();
	...
	public ByteBuf toBinary() {
		this.length = 16+2+8+1+Utils.getUTF8StringLength(senderName)+8+1
