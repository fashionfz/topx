...
public class ConsultTimeRejMessage implements Message{
	...
	public ConsultTimeRejMessage() {
		super();
	}

	public ConsultTimeRejMessage(Long senderId, Long receiverId, Long date,
		...
		this.length = 2+8+8 +6 +senderName.getBytes().length+receiverName.getBytes().length+8+2*1;
	}
