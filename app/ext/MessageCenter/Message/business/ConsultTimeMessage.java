...
public class ConsultTimeMessage implements Message{
	...
	public ConsultTimeMessage() {
		super();
	}

	
	
	public ConsultTimeMessage(Long senderId, Long receiverId, Long date,
		...
		this.length = 2+8+8 +6 +senderName.getBytes().length+receiverName.getBytes().length+2*1;
	}
