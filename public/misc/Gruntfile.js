...
module.exports = function(grunt) {
    ...
    var createUedImport={};
    createUedImport[distPath + 'ued.import.js'] = ['ued.conf.js', 'ued.concat.js','import.js'];
    ...
    grunt.registerTask('dist-css', ['concat:default', 'cssmin', 'dist-clean']);
    grunt.registerTask('dist-js', ['requirejs', 'concat:default', 'uglify', 'dist-clean']);

    grunt.registerTask('default', ['dist-copy', 'dist-js', 'dist-css', 'dist-clean']);

    grunt.registerTask('test', ['concat:cui']);



    /*grunt.registerTask("makeui", "build ui moudle", function() {
        var filepath = "js/"+ version +"/toolbar.htm";
        var code = grunt.file.read(filepath);
        code = code.replace(/\r|\n|\s{2,}/g, "");
        grunt.file.write("js/"+ version +"/toolbar.tmpl.js", "YiQiGuang.ToolbarTmpl = '"+ code + "';");
