...
define('module/pinyin', [], function(){
    return {
        ...
        getQP : function(l1){
            var l2 = l1.length,
                I1 = "",
                //reg = new RegExp('[a-zA-Z0-9\- ]'), //空格转换成-
                reg = new RegExp('[a-zA-Z0-9\]');  //去掉空格
        ...
        getHP : function(str){
            var self = this,
                result = "",
                //regStr = str.replace(/(^\s*)|(\s*$)/g,''),
                regStr = str.replace(/\s/g, ''),
                strLH = regStr.length;

            if (strLH == 2) {
                strLH = self.getQP(regStr);
            } else {
                for(var i = 0;i < strLH; i++){
                    if(i!=0){
                        result += self.getJP(regStr.charAt(i).toString()) ;
                    } else {
                        result += self.getQP(regStr.charAt(i).toString());
                    }
                }
            }
            return result;
