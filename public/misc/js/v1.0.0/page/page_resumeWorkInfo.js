...
require([
				...
				'<div class="user-exp-content">',
					...
					'<div class="collapse-pannel hide">',
						'<div class="user-info-block clearfix pr z5">',
							'<div class="info-key">',
								'<label><em class="red">*</em>在职时间：</label>',
							'</div>',
						...
						'<div class="user-info-block clearfix">',
							'<div class="info-key">',
								'<label><em class="red">*</em>公司名称：</label>',
							'</div>',
							'<div class="info-value">',
						...
						'<div class="user-info-block clearfix">',
							'<div class="info-key">',
								'<label><em class="red">*</em>职位名称：</label>',
							'</div>',
							'<div class="info-value">',
	...
	var saveUserInfo = function(successInfo){
        ...
        var $dutyShow = $(".user-exp .user-exp-main").find(".duty");
    ...
    var initIntroduction = function(){
        ...
        var introduction = $('.text-workInfo');
        ...
        introduction.on("blur keyup", function(){
            ...
            if (textLen < maxLen && textLen !== 0) {
                ...
                errBox.html('职务描述最多' + maxLen + '字符，现已经超过<span class="num">' + more + '</span>字符');
            }else{
                errBox.html('');
            }
        });
    ...
    var initWorkInfo = function(){
        ...
        var editItem = function(elem){
            ...
            DetailAPI.checkDateAll({
                ...
                tips: tipsYear,
                err: errStr.timeErr,
                editSelect: editSelect, editModule: editModule
            });
